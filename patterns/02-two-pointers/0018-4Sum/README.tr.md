...
Bu, 4Sum problemi için en optimal çözümdür ve 3Sum probleminin mantığı üzerine inşa edilmiştir. 
Diziyi en başta küçükten büyüğe sıralayarak, ilk iki sayıyı iç içe geçmiş iki döngüyle (`i` ve `j`) sabitleriz. Kalan iki sayıyı ise dizinin geri kalan kısmında **Two Pointers** (`lo` ve `hi`) tekniği ile ararız.
...
En basit yöntem, dört tane iç içe döngü kurarak olası tüm dörtlü kombinasyonları tek tek kontrol etmektir. 
"Benzersiz dörtlüler" kuralını sağlamak için ise bulunan sonuçları sıralayıp bir Hash Set içerisine atabiliriz.
