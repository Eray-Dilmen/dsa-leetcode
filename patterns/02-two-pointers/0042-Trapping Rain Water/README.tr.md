...
> **Output:** `6`  
> **Explanation:** Yukarıdaki yükseklik haritası (siyah kısım) `[0,1,0,2,1,0,1,3,2,1,2,1]` dizisi ile temsil edilmektedir. Bu durumda, aradaki boşluklara 6 birim yağmur suyu (mavi kısım) hapsolur.
